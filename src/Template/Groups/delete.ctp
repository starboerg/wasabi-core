...
echo $this->Form->create($group, ['class' => 'no-top-section', 'type' => 'post']);
    ...
    echo $this->Html->div('form-controls');
        echo $this->Form->button(__d('wasabi_core', 'Move Members & Delete Group'), array('div' => false, 'class' => 'button red'));
        echo $this->Html->backendLink(__d('wasabi_core', 'Cancel'), '/groups');
